...
{
public:
	PoseGraph(MapDrawer* _pmapdrawer);
	~PoseGraph();
	//void registerPub(ros::NodeHandle &n);
	void addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop, vinssystem* _pvinssystem);
	void loadKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop, vinssystem* _pvinssystem);
	...
	void savePoseGraph();
	void loadPoseGraph(vinssystem* _pvinssystem);
	//void publish();
	Vector3d t_drift;
	double yaw_drift;
	Matrix3d r_drift;
	...
	Vector3d w_t_vio;
	Matrix3d w_r_vio;
    std::vector<pair<int,MyOdometryMsg>> vallframes_noloop;
	std::mutex m_allframes;
	MapDrawer* mpmapdrawer;
	void SetDrawerKeyFrames();
